# Vendored verbatim from Plumb, Molitor, Talwalkar (NeurIPS 2018),
# "Model Agnostic Supervised Local Explanations":
#   https://github.com/GDPlumb/MAPLE/blob/master/Code/MAPLE.py
#
# Reproduced here so our benchmark uses the paper authors' exact
# algorithm (forest fit, leaf-weight formula, DStump feature-selection
# CV, local ridge) — no edits, no drift.  All credit to the authors.
# Wrapper around this class lives in method_maple.py.
